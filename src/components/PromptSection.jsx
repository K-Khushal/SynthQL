...
export default function PromptSection() {
    ...
    return (
        <div className="bg-[#1e1e2d] p-8 max-w-2xl mx-auto rounded-lg tracking-wide">
            ...
            <div className="space-y-4 py-4 tracking-wide">
                ...
                <button className="bg-[#bd1e59] hover:bg-[#d5306f] text-white w-full py-2 rounded">Generate SQL</button>
                <div className="bg-[#252535] border border-[#34344c] text-white p-4 rounded-md">
                    ...
                    <button onClick={handleCopy} className="mt-4 bg-[#34344c] hover:bg-[#4c4c63] text-white w-full py-2 rounded">
                        Copy
                    </button>
                    {showToast && (
                        <div
                            className="bg-green-500 py-2 px-4 rounded-md text-white text-center fixed bottom-4 right-4 flex items-center justify-center gap-4 tracking-wider">
